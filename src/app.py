...
with st.sidebar:
    ...
    st.text_input("User", value="sql12742567", key="User")
    st.text_input("Password", type="password", value="sDZlfGHqGT", key="Password")
    st.text_input("Database", value="sql12742567", key="Database")
