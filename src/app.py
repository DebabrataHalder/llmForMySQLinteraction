...
with st.sidebar:
    ...
    st.text_input("User", value="sql12736414", key="User")
    st.text_input("Password", type="password", value="uD6LB4VZI5", key="Password")
    st.text_input("Database", value="sql12736414", key="Database")
